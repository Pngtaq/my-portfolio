export default function ProjectsTag(props) {
  ...
  return (
    <a
      ...
      href={link}
      className="border p-2 border-gray-300 dark:border-[#333] rounded-lg space-y-1 hover:-translate-y-0.5 duration-500 hover:duration-200 hover:shadow-[0_5px_20px_-5px_rgba(0,0,0,0.1)] ease-in-out transition-all"
    >
